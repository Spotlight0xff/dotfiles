...
let s:N1   = [ '#ff005f' , '#dfff00' , 4  , 103 , 'bold']
let s:N2   = [ '#ffffff' , '#444444' , 254 , 238 ]
let s:N3   = [ '#9cffd3' , '#202020' , 85  , 234 ]
let g:airline#themes#simple#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)

" Here we define overrides for when the buffer is modified.  This will be
" applied after g:airline#themes#simple#palette.normal, hence why only certain keys are
" declared.
...
let g:airline#themes#simple#palette.replace = copy(g:airline#themes#simple#palette.insert)
let g:airline#themes#simple#palette.replace.airline_a = [ s:I2[0]   , '#af0000' , s:I2[2] , 124     , ''     ]
let g:airline#themes#simple#palette.replace_modified = g:airline#themes#simple#palette.insert_modified
...
let g:airline#themes#simple#palette.inactive = airline#themes#generate_color_map(s:IA1, s:IA2, s:IA3)
...
let g:airline#themes#simple#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
